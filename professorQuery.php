  ...
  <body>
    ...
    function get_query($conn)
    {
      ...
      if (isset($_POST['ssnQuery'])) {
        $stringOfQuery = "SELECT cTitle, sClassroom, sBeginTime, sEndTime, mSectionNum, mDays from sections INNER JOIN professors on sections.sProfSSN = professors.pSSN INNER JOIN courses on sections.sCourseNum = courses.cNum INNER JOIN meeting_days.mSectionNum on sections.sNum=meeting_days.mSectionNum WHERE professors.pSSN= '" . $_POST['ssnQuery'] . "' ";
